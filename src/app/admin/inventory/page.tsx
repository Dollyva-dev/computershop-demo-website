...
export default function InventoryPage() {
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto relative min-h-screen">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="pl-10 pr-4 py-2.5 bg-[#0b0b12] border border-white/10 rounded-xl text-sm text-white focus:outline-none focus:border-blue-500 transition-colors w-64"
            />
          </div>
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-xl transition-colors shadow-[0_0_15px_rgba(59,130,246,0.3)]"
          >
            <Plus size={18} />
            Add Product
          </button>
      ...
      <div ref={tableRef} className="bg-[#0b0b12] border border-white/5 rounded-2xl overflow-hidden shadow-xl">
              ...
              {filteredInventory.map((item) => (
                <tr key={item.id} className="stagger-row hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-black/40 border border-white/5 flex items-center justify-center p-1 relative">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl bg-[#0b0b12] border border-white/10 rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              ...
              {/* Image Upload Area */}
              <div className="w-full h-40 border-2 border-dashed border-white/10 rounded-xl flex flex-col items-center justify-center bg-white/5 hover:bg-white/10 transition-colors cursor-pointer group">
            ...
            <div className="p-6 border-t border-white/5 flex items-center justify-end gap-4 bg-white/[0.02] rounded-b-2xl">
              <button 
                onClick={() => setIsModalOpen(false)}
              ...
              <button 
                className="px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors shadow-[0_0_15px_rgba(59,130,246,0.3)]"
              >
                Save Product
              </button>
            </div>
